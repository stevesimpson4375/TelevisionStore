...
namespace TelevisionStore.Controllers
{
    public class ItemListsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemListId,SaleId,TelevisionId")] ItemList itemList)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemListId,SaleId,TelevisionId")] ItemList itemList)
        {
            if (ModelState.IsValid)
            {
